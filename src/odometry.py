...
class Odometry:
    ...
    def calculatePosition(self, motorValues: List[Tuple[int, int]], lastNodeColor: Color = Color.UNDEFINED,
                          currentNodeColor: Color = Color.UNDEFINED):
        ...
        if lastNodeColor is not Color.UNDEFINED and currentNodeColor is not Color.UNDEFINED:
            if (lastNodeColor == currentNodeColor and (roundedGridX + roundedGridY) % 2 != 0) or (
                    lastNodeColor != currentNodeColor and (roundedGridX + roundedGridY) % 2 == 0):
                # korrektur
        ...
        print("ODO Delta: ", roundedGridX, ";", roundedGridY)
